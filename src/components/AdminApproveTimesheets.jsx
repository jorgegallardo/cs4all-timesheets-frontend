...
const AdminTimesheetApproval = () => {
  ...
  const fetchTeacherTimesheets = async () => {
    try {
      const response = await axios.get(process.env.REACT_APP_API_SERVER + '/timesheets/admin', {
        headers: {
              ...
              <Table.Row negative key={timesheet._id}>
                ...
                <Table.Cell>
                  ...
                  >
                    ...
                    <Modal.Content>
                      ...
                      <iframe src={timesheet.filename + '#toolbar=0'} width="100%" height="300px"></iframe>
                    </Modal.Content>
                    <Modal.Actions>
                ...
                <Table.Cell>
                  <Dropdown
                    ...
                    selection
                    fluid
                    value={timesheetStatusOptions.find(opt => opt.text === timesheet.status).value}
                  />
                </Table.Cell>
              </Table.Row>
            ))}
